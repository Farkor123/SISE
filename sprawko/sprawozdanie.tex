...
Zawsze znajduje rozwiązanie położone tak płytko jak to możliwe.
...
Czas wykonania(rys.\ref{BFS:time}) i ilość odwiedzonych stanów(rys.\ref{BFS:visited}) wyraźnie korelują z ilością przetworzonych stanów, nie różnicując się zbytnio w zależności od porządku.
